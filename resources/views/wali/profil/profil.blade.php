...
<div class="max-w-5xl mx-auto bg-white rounded-xl shadow-md p-6 mb-6 flex items-center gap-6">
  <img src="{{ asset('images/wali/profil.jpeg') }}" alt="foto profil" class="h-20 w-20 rounded-full object-cover ring-2 ring-blue-600">
  <div class="flex-1">
    <h2 class="text-sm font-semibold text-gray-800">Keiichiro Asaka</h2>
    <p class="text-sm text-gray-500">X IPA 1</p>
...
<div class="max-w-5xl mx-auto bg-white rounded-xl shadow-md p-6 mb-6">
  ...
  <div class="space-y-1">
    ...
    <p class="text-sm text-gray-800 font-medium">Haruka Kudo</p>
  </div>
  <div class="space-y-1">
  ...
  <div class="space-y-1">
    ...
    <p class="text-sm text-gray-800 font-medium">569244254529</p>
  </div>
  <div class="space-y-1">
  ...
  <div class="bg-white rounded-xl shadow-lg p-6 w-full max-w-lg relative">
    ...
    <form class="space-y-4">
      <div class="flex flex-col items-center space-y-2">
        <div class="relative">
          <img id="preview-general" src="{{ asset('images/wali/profil.jpeg') }}" class="h-24 w-24 rounded-full ring-2 ring-blue-500 object-cover">
  ...
  <div class="bg-white rounded-xl shadow-lg p-6 w-full max-w-lg relative">
    ...
    <form class="space-y-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label class="text-xs text-gray-600">NIS</label>
          <input type="text" class="w-full border rounded-lg px-3 py-2 text-sm">
        </div>
        <div>
        ...
        <div>
          <label class="text-xs text-gray-600">NISN</label>
          <input type="text" class="w-full border rounded-lg px-3 py-2 text-sm">
        </div>
        <div>
