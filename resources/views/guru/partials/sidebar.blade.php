  ...
  <div class="flex flex-col w-64 bg-white border-r border-gray-200">
    ...
    <nav class="flex-1 px-4 py-4 space-y-1 text-sm font-medium text-gray-700">
      <a href="/guru/dashboard"
         ...
         {{ Request::is('guru/dashboard') ? 'bg-blue-100 text-blue-600' : 'hover:bg-blue-50' }}">
         <i class="fas fa-tachometer-alt min-w-[20px]"></i> Dashboard
      </a>
      <a href="/guru/kelas"
         class="flex items-center gap-3 px-3 py-3 rounded-md transition sidebar-link 
         {{ Request::is('guru/kelas') ? 'bg-blue-100 text-blue-600' : 'hover:bg-blue-50' }}">
         <i class="fas fa-school min-w-[20px] "></i> Daftar Kelas
      </a>
      <a href="/guru/jadwal"
            class="flex items-center gap-3 px-3 py-3 rounded-md transition sidebar-link 
            {{ Request::is('guru/jadwal') ? 'bg-blue-100 text-blue-600 ' : 'hover:bg-blue-50' }}">
            <i class="fas fa-calendar min-w-[20px]"></i> Jadwal
        </a>
        
        <a href="/guru/presensi"
            class="flex items-center gap-3 px-3 py-3 rounded-md transition sidebar-link 
            {{ Request::is('guru/presensi') ? 'bg-blue-100 text-blue-600 ' : 'hover:bg-blue-50' }}">
            <i class="fas fa-user-check min-w-[20px]"></i> Presensi
        </a>
        <a href="/guru/profil"
            class="flex items-center gap-3 px-3 py-3 rounded-md transition sidebar-link 
            {{ Request::is('guru/profil') ? 'bg-blue-100 text-blue-600 ' : 'hover:bg-blue-50' }}">
    ...
    <div class="p-4 border-t border-gray-200">
      <a href="/"
         class="flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:bg-red-100 hover:text-red-600 transition">
